...
//  tree_null_.erase_node(4); // цвет не поменяся
//  tree_null_.erase_node(6); // цвета не совпадают
//  tree_null_.erase_node(70); // цвета не совпадают
  tree_null_.erase_node(85);
//  tree_null_.erase_node(1); // цвета не совпадают
